...
<jsp:include page="../layout/menubar.jsp"/>
	...
	<div class="container">
		...
		<form class="form-horizontal" name="detailForm" method="post" action="addProductView.jsp" enctype="multipart/form-data" >
		  ...
		  <div class="form-group">
		    <label for="prodDetail" class="col-sm-offset-1 col-sm-3 control-label" >제조일자를 선택하세요</label>
		    <div class="col-sm-4">
		  ...
		  <div class="form-group">
		    <label for="prodDetail" class="col-sm-offset-1 col-sm-3 control-label" >상품가격</label>
		    <div class="col-sm-4">
		  ...
		  <div class="form-group">
		    <label for="prodDetail" class="col-sm-offset-1 col-sm-3 control-label" >상품수량</label>
		    <div class="col-sm-4">
		      <input type="text" class="form-control" id="totalEA" name="totalEA" placeholder="상품수량을 입력하세요">
		    </div>
		  </div>
